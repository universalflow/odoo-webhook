...
class RestApi(http.Controller):
    ...
    def get_response(self, status_code, status, data=None):
        ...
        if data:
            try:
                ...
                if request.httprequest.headers.get('Accept') == 'application/xml':
                    response.data = data
    ...
    def call_report(self, xml_id, id=None, **kwargs):
        ...
        report = {'report': datas}
        if request.httprequest.headers.get('Accept') == 'application/xml':
            report = dicttoxml.dicttoxml(report,root=False)
        return self.get_response(200, str(200), report)
    ...
    def perform_request(self, object, method=None, id=None, kwargs={}, user=None):
        ...
        if request_data and request.httprequest.headers.get('Accept') == 'application/xml':
            try:
        ...
        try:
            ...
            return self.get_response(403, '403', {'error': {'code': 403, 'message': hasattr(e, 'message') and str(e.message) or str(e)}})
